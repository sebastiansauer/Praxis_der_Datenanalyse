...
% ---------------------------------------------------------------------------
% etoolbox boolean flags!
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\newbool{showAuthorInFootline}    %
\booltrue{showAuthorInFootline}   %

\newbool{showTitleInFootline}     %
\booltrue{showTitleInFootline}    %

\newbool{showDateInFootline}      %
\booltrue{showDateInFootline}     %
...
\ifthenelse{\equal{\insertframenumber}{1}}{%
      ...
      \begin{beamercolorbox}[ht=4ex,leftskip=.2cm,rightskip=.3cm]{author in head/foot}
        ...
        \hfil
        \ifbool{showAuthorInFootline}{\insertshortauthor  \, $|$ \,}{\phantom{\insertshortauthor $|$} }\ifbool{showTitleInFootline}{  \inserttitle }{ \phantom{\inserttitle} }%
