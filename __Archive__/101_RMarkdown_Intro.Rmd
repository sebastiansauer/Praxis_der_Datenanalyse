...
```{r echo = FALSE, fig.cap = "Neue Rmd-Datei erstellen"}
...
```{r echo = FALSE, fig.cap  = "Optionen für neue Rmd-Dateien", fig.height = 3}
knitr::include_graphics("images/new_md2.png")
```
...
```{r echo = FALSE, fig.cap = "Wir stricken"}
...
```{r echo = FALSE, fig.cap = "HTML-Datei aus Rmd-Datei erstellt"}
