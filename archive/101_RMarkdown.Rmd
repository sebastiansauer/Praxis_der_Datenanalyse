...
```{r echo = FALSE, fig.cap = "Neue Rmd-Datei erstellen", fig.height = 3, out.width = "30%"}
...
```{r echo = FALSE, fig.cap = "Wir stricken", fig.height = 3, out.width = "50%"}
knitr::include_graphics("images/rmd_demo.png")
```
...
```{r echo = FALSE, fig.cap = "HTML-Datei aus Rmd-Datei erstellt", fig.height = 3}
knitr::include_graphics("images/rmd_all_panes.png")
```
...
```{r echo = FALSE, fig.cap = "Die Arbeitsschritte mit RMarkdown"}
knitr::include_graphics("images/Rmarkdown_flow.pdf")
```
