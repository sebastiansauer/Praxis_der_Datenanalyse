...
Also, los geht's: Zuerst wählen wir aus der Fülle der Daten, die Spalten, die uns interessieren: Die 10 Extraversionsitems, in diesem Fall.

```{r}
extra_items <- select(extra, i01:i10)
```
