...
```{r resids_plot, echo = FALSE, results = "hold"}
...
```{r lm_overfitting_predict}
lm2_predict <- predict(lm2, newdata = test)
```

Diese Syntax sagt:

```{block2, lm2-predict, type='rmdpseudocode', echo = TRUE}
