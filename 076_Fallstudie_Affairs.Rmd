...
Insgesamt bleibt die erklärte Varianz in sehr bescheidenem Rahmen: `r r2_lm6`. Das zeigt uns, dass es immer noch nur schlecht verstanden ist -- im Rahmen dieser Analyse -- welche Faktoren die Affärenhäufigkeit erklärt.
...
pander::pander(data.frame(df), caption = "Befehle des Kapitels 'Fallstudien'")
