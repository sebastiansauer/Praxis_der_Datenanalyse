...
knitr::include_graphics("images/tidy/gather_spread.png")
...
```{r bsp-abb, echo = FALSE, fig.cap = "Ein Beispiel für eine Abbildung zu einer Normalform-Tabelle"}

knitr::include_graphics("images/tidy/bsp_diagramm-crop.pdf")
```
