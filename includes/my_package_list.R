...
# Diese Liste stammt vom 2017-07-01 18:04:28
packages <- c()
#  010_Organisatorisches.Rmd
packages <- c(packages,  "gridExtra", "grid" )
#  020_Rahmen.Rmd
packages <- c(packages,  "dplyr", "name_des_pakets", "dplyr", "dplyr", "prada" )
#  030_Tidy_Data.Rmd
packages <- c(packages,  "readr", "tidyr" )
#  040_Datenjudo.Rmd
packages <- c(packages,  "methods", "tidyverse", "stringr", "car", "desctable", "lsr", "methods" )
#  043_Typische_Probleme_Datenanalyse.Rmd
packages <- c(packages,  "methods", "tidyverse", "corrr", "gridExtra", "car" )
...
packages <- c(packages,  "methods", "pwr", "tidyverse", "broom", "BayesFactor" )
#  071_Regression.Rmd
...
packages <- c(packages,  "tidyverse", "psych", "broom", "corrplot", "titanic", "AER", "psych", "tidyverse", "broom", "dplyr", "MBESS", "pander" )
#  082_Clusteranalyse.Rmd
packages <- c(packages,  "tidyverse", "cluster", "broom" )
#  083_Dimensionsreduktion.Rmd
packages <- c(packages,  "methods", "corrplot", "gplots", "nFactors", "tidyverse", "psych", "MASS", "plot3D" )
#  090_Textmining.Rmd
