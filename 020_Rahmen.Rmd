...
Alternativ können Sie die Daten auch im Ordner `data` im Github-Repositorium herunterladen. Gehen Sie auf die Github-Seite dieses Kurses^[<https://github.com/sebastiansauer/Praxis_der_Datenanalyse>], klicken Sie auf den großen grünen Button "Clone or download", wählen Sie dann "Download ZIP", um alle Dateien herunterzuladen. Nach dem Entzippen können Sie dann auf alle Dateien, inklusive Daten, zugreifen. Die folgenden Datensätze nutzen wir im Rahmen dieses Kurses:
