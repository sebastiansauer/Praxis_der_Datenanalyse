...
Wenn das Paket geladen ist, können Sie auch auf den Parameter `package = ...` verzichten, da geladene Pakete automatisch durchsucht werden. Außerden können Sie sich die Daten von [Github](https://github.com/sebastiansauer/Praxis_der_Datenanalyse) herunter laden (s. Abschnitt \@ref(gh-repo)).
...
- Datensatz `Werte` URL: <https://osf.io/zg89r/> [@Gansser_2017]; es handelt sich um Werte von Studierenden
