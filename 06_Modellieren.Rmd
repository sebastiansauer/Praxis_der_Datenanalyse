...
```{r echo = FALSE, fig.cap = "Modellieren"}
...
```{r echo = FALSE, fig.cap = "Ein Beispiel für Modellieren", out.width = "90%", fig.height = 1}
...
```{r modell-bsp2, echo = FALSE, fig.cap = "Ein etwas aufwändigeres Modell"}
...
```{r echo = FALSE, fig.cap = "Welches Modell passt am besten zu diesen Daten?", out.width = "90%", }
...
grid.arrange(p1, p2, p3, p4, ncol = 4, heights=unit(0.4, "npc"))
