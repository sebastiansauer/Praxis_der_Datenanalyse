...
```{r sir-fisher, echo = FALSE, fig.cap = "Der größte Statistiker des 20. Jahrhunderts (p < .05)", out.width = "10%", fig.align = "center"}
...
```{r who-said, echo = FALSE, fig.cap  = "Der p-Wert wird oft als wichtig erachtet", fig.align = "center"}
...
```{r fig-moslems, echo = FALSE, fig.caption = "Moslem und Terrorist zu sein, ist nicht das gleiche."}
knitr::include_graphics("images/moslems_terroristen_crop.pdf")
```
...
```{r fig-dino, echo = FALSE, fig.height = 2, fig.align = "center"}
