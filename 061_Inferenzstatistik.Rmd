...
```{r sir-fisher, echo = FALSE, fig.cap = "Der größte Statistiker des 20. Jahrhunderts (p < .05)", out.width = "30%", fig.align = "center"}
...
```{r who-said, echo = FALSE, out.width = "15%", fig.cap  = "Der p-Wert wird oft als wichtig erachtet", fig.align = "center"}
