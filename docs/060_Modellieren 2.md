...
Welche drei Ziele des Modellierens kann man unterscheiden?^[\@ref(Ziele-des-Modellierens)]


### Bias-Varianz-Abwägung

Betrachten Sie Abb. \@ref(plot-bias-variance2). Welches der beiden  Modelle (visualiert im jeweiligen Plot) ist wahrscheinlich...
