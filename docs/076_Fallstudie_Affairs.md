...
#> [1] knitr_1.15.1  broom_0.4.2   MBESS_4.2.0   corrplot_0.77 dplyr_0.5.0  
#> [6] ggplot2_2.2.1 psych_1.7.5  
#> 
#> loaded via a namespace (and not attached):
#>  [1] Rcpp_0.12.10        magrittr_1.5        mnormt_1.5-5       
#>  [4] munsell_0.4.3       colorspace_1.3-2    lattice_0.20-34    
#>  [7] R6_2.2.1            rlang_0.1           stringr_1.2.0      
#> [10] plyr_1.8.4          tools_3.3.2         parallel_3.3.2     
#> [13] grid_3.3.2          nlme_3.1-130        gtable_0.2.0       
#> [16] DBI_0.6-1           htmltools_0.3.6     assertthat_0.2.0   
#> [19] yaml_2.1.14         lazyeval_0.2.0.9000 rprojroot_1.2      
#> [22] digest_0.6.12       tibble_1.3.0.9002   bookdown_0.3       
#> [25] tidyr_0.6.2         reshape2_1.4.2      codetools_0.2-15   
#> [28] evaluate_0.10       rmarkdown_1.5       labeling_0.3       
